...
map_title <- tags$div(
  HTML('<b>Bruto jobtoename per provincie, 2015-2016 (<a href="https://dynamresearch.be/">Dynam-Reg</a>)</b>')
)
...
map_title <- tags$div(
  HTML('<b>Augmentation brute par province, 2015-2016 (<a href="https://dynamresearch.be/">Dynam-Reg</a>)</b>')
)
